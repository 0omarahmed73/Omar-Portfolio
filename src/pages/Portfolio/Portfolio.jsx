        ...
        >
          ...
          >
            ...
            <div className={styles.projects}>
              <Project
                title="United Elevators - Odoo Theme"
                link="https://drive.google.com/file/d/1QTwINXquRSxurKY5cr34aBi5pzjNWYJr/view?usp=sharing"
                functions={() => setImageIndex(10)}
              />
              <Project
                title="Natchi Beach - Odoo Theme"
                link="https://drive.google.com/file/d/1dZZfgkdu4tLS_UIgrGFNOB7FElSCDeBG/view?usp=sharing"
                functions={() => setImageIndex(11)}
              />
              <Project
                title="NOB Dashboard - Odoo Module"
                link="https://drive.google.com/file/d/1nj5wbLKfuF124iWJjOsIOq5XRIGSG7fV/view?usp=sharing"
              ...
              <Project
                ...
                link="https://weather-app-last-update.netlify.app/"
                functions={() => setImageIndex(9)}
              />
              <Project
